 ...
 * 传感器详情
 */
public class LampSensorDetailFragment extends MyBaseFragment {
    ...
    public static LampSensorDetailFragment getInstance(MapLampCommonDevList.DataBean dataBean) {
        LampSensorDetailFragment lampPoleDetailFragment = new LampSensorDetailFragment();
