...
import com.exc.roadlamp.utils.DpPxUtils;
...
public class DownloadCircleView extends View {
    ...
    Paint mTxtPaint;
    int outsideRadius= DpPxUtils.dp2px(80);
    int progressWidth =DpPxUtils.dp2px(2);
    float progressTextSize  = DpPxUtils.dp2px(8);
    Context context;
    ...
    private void init(Context context) {
        int progressColor = Color.parseColor("#0e9cff");//进度球颜色
