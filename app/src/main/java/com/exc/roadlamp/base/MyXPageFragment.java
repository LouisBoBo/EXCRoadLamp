 ...
 */
public abstract class MyXPageFragment extends Fragment {
    /**
     * 所在activity
     */
     ...
     */
    private MyCoreSwitcher mPageCoreSwitcher;
    ...
    public final void popToBack(String pageName, Bundle bundle) {
        MyCoreSwitcher coreSwitcher = getSwitcher();
        if (coreSwitcher != null) {
            if (pageName == null) {
                coreSwitcher.popPage();
            } else {
                if (this.findPage(pageName)) {
                    MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle);
     ...
     * @return 页面切换Switcher
     */
    public MyCoreSwitcher getSwitcher() {
        synchronized (MyXPageFragment.this) {
            ...
            if (mPageCoreSwitcher == null) {
                ...
                if (context != null && context instanceof CoreSwitcher) {
                    mPageCoreSwitcher = (MyCoreSwitcher) context;
                }
                if (mPageCoreSwitcher == null) {
                    MyXPageActivity topActivity = MyXPageActivity.getTopActivity();
                    if (topActivity != null) {
     ...
     * 设置Switcher
     *
     * @param pageCoreSwitcher MyCoreSwitcher对象
     */
    public MyXPageFragment setSwitcher(MyCoreSwitcher pageCoreSwitcher) {
    ...
    public boolean isFragmentTop(String fragmentTag) {
        MyCoreSwitcher pageCoreSwitcher = this.getSwitcher();
     ...
     * @return 打开的fragment对象
     */
    public <T extends MyXPageFragment> T openPage(Class<T> clazz, Bundle bundle, CoreAnim coreAnim) {
    ...
    public final Fragment openPage(String pageName, Bundle bundle, CoreAnim coreAnim) {
        return openPage(pageName, bundle, MyCoreSwitchBean.convertAnimations(coreAnim), true);
    }
    ...
    public final Fragment openPage(String pageName, Bundle bundle, int[] anim, boolean addToBackStack, boolean newActivity) {
        ...
        MyCoreSwitcher coreSwitcher = this.getSwitcher();
        if (coreSwitcher != null) {
    ...
    public final Fragment openPage(String pageName, Bundle bundle, CoreAnim coreAnim, boolean addToBackStack) {
        return openPage(pageName, bundle, MyCoreSwitchBean.convertAnimations(coreAnim), addToBackStack, false);
    }
    ...
    public final Fragment openPage(String pageName, Bundle bundle, CoreAnim coreAnim, boolean addToBackStack, boolean newActivity) {
        return openPage(pageName, bundle, MyCoreSwitchBean.convertAnimations(coreAnim), addToBackStack, newActivity);
    }
    ...
    public Fragment gotoPage(String pageName, Bundle bundle, CoreAnim coreAnim, boolean newActivity) {
        MyCoreSwitcher pageCoreSwitcher = this.getSwitcher();
        if (pageCoreSwitcher != null) {
            MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, coreAnim, true, newActivity);
     ...
     * @return 打开的fragment对象
     */
    public final <T extends MyXPageFragment> T openPageForResult(Class<T> clazz, Bundle bundle, int requestCode) {
    ...
    public final Fragment openPageForResult(boolean newActivity, String pageName, Bundle bundle, CoreAnim coreAnim, int requestCode) {
        return openPageForResult(newActivity, pageName, bundle, MyCoreSwitchBean.convertAnimations(coreAnim), requestCode);
    }
     ...
     * @return 打开的fragment对象
     */
    public final Fragment openPage(@NonNull MyPageOption pageOption) {
        MyCoreSwitcher switcher = this.getSwitcher();
        if (switcher != null) {
            MyCoreSwitchBean page = pageOption.toSwitch();
...
//        mRootView = inflateView(inflater, container);
        mRootView = setFragmentView(inflater, container);
        initArgs();
        initPage();
        return mRootView;
    }
...
//    }
    ...
    public void startActivity(Intent intent) {
        ...
        if (MyCoreConfig.getContext().getPackageManager().resolveActivity(intent, PackageManager.MATCH_DEFAULT_ONLY) != null) {
            try {
