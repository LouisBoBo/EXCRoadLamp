...
public final class MyUtils {
    ...
    public static MyCoreSwitchBean toSwitch(@NonNull MyPageOption pageOption) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageOption.getPageName(), pageOption.getBundle(), pageOption.getAnim(), pageOption.isAddToBackStack(), pageOption.isNewActivity());
