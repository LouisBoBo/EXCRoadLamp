 ...
 */
public class MyXPageActivity extends AppCompatActivity implements MyCoreSwitcher {
    /**
     * 应用中所有XPageActivity的引用
     */
    private static List<WeakReference<MyXPageActivity>> sActivities = new ArrayList<>();
    /**
     * 当前activity的引用
     */
    private WeakReference<MyXPageActivity> mCurrentActivity = null;
    /**
     * 记录首个CoreSwitchBean，用于页面切换
     */
    protected MyCoreSwitchBean mFirstCoreSwitchBean;
    /**
     * 主线程Handler
     */
     ...
     * ForResult 的fragment
     */
    private MyXPageFragment mFragmentForResult = null;
    /**
     * 请求码，必须大于等于0
     */
     ...
     * @return 栈顶Activity
     */
    public static MyXPageActivity getTopActivity() {
        if (sActivities != null) {
            int size = sActivities.size();
            if (size >= 1) {
                WeakReference<MyXPageActivity> ref = sActivities.get(size - 1);
                if (ref != null) {
                    return ref.get();
                }
            }
    ...
    protected String getPageName() {
        MyXPageFragment frg = getActiveFragment();
        if (frg != null) {
     ...
     */
    private void finishActivity(MyXPageActivity activity, boolean showAnimation) {
        if (activity != null) {
            activity.finish();
            //从activity列表中移除当前实例
    ...
    public boolean isFragmentTop(String fragmentTag) {
        int size = sActivities.size();
        if (size > 0) {
            WeakReference<MyXPageActivity> reference = sActivities.get(size - 1);
            MyXPageActivity activity = reference.get();
    ...
    public boolean findPage(String pageName) {
        ...
        for (int j = size - 1; j >= 0; j--) {
            WeakReference<MyXPageActivity> reference = sActivities.get(j);
            if (reference != null) {
                MyXPageActivity activity = reference.get();
                if (activity == null) {
     ...
     */
    @Override
    public Fragment gotoPage(MyCoreSwitchBean page) {
        if (page == null) {
        ...
        for (int i = size - 1; i >= 0; i--) {
            WeakReference<MyXPageActivity> ref = sActivities.get(i);
            if (ref != null) {
                MyXPageActivity item = ref.get();
                if (item == null) {
                    PageLog.d("item null");
                    continue;
                }
     ...
     * @return 是否弹出成功
     */
    protected boolean popFragmentInActivity(final String pageName, Bundle bundle, MyXPageActivity findActivity) {
        if (pageName == null || findActivity == null || findActivity.isFinishing()) {
            ...
            if (fragmentManager != null) {
                ...
                if (frg != null && frg instanceof MyXPageFragment) {
                    ...
                    ((MyXPageFragment) frg).onFragmentDataReset(bundle);
                    return true;
                }
            }
        }
     ...
     *
     * @param page MyCoreSwitchBean对象
     */
    public void startActivity(MyCoreSwitchBean page) {
        try {
            Intent intent = new Intent(this, page.getContainActivityClazz());
            intent.putExtra(MyCoreSwitchBean.KEY_SWITCH_BEAN, page);
    ...
    @Override
    public Fragment openPageForResult(MyCoreSwitchBean page, MyXPageFragment fragment) {
        if (page != null) {
            if (page.isNewActivity()) {
                ...
                MyXPageFragment frg = MyCorePageManager.getInstance().openPageWithNewFragmentManager(getSupportFragmentManager(), pageName, bundle, animations, addToBackStack);
                if (frg == null) {
                    return null;
                }
                final MyXPageFragment opener = fragment;
                frg.setRequestCode(page.getRequestCode());
                frg.setFragmentFinishListener(new MyXPageFragment.OnFragmentFinishListener() {
                    @Override
    ...
    //     */
//    @Override
//    public Fragment openPageForResult(CoreSwitchBean page, MyXPageFragment fragment) {
//        if (page != null) {
//            if (page.isNewActivity()) {
//                PageLog.d("openPageForResult start new activity-----" + fragment.getPageName());
//                mFragmentForResult = fragment;
...
//                int[] animations = page.getAnim();
//                boolean addToBackStack = page.isAddToBackStack();
//                MyXPageFragment frg = CorePageManager.getInstance().openPageWithNewFragmentManager(getSupportFragmentManager(), pageName, bundle, animations, addToBackStack);
//                if (frg == null) {
//                    return null;
//                }
//                final MyXPageFragment opener = fragment;
...
//    }
     ...
     * @param page MyCoreSwitchBean对象
     */
    public void startActivityForResult(MyCoreSwitchBean page) {
        try {
            Intent intent = new Intent(this, page.getContainActivityClazz());
            intent.putExtra(MyCoreSwitchBean.KEY_SWITCH_BEAN, page);
            intent.putExtra(MyCoreSwitchBean.KEY_START_ACTIVITY_FOR_RESULT, true);
     ...
     */
    @Override
    public Fragment openPage(MyCoreSwitchBean page) {
        boolean addToBackStack = page.isAddToBackStack();
        ...
        if (newActivity) {
            ...
            String pageName = page.getPageName();
            return MyCorePageManager.getInstance().openPageWithNewFragmentManager(getSupportFragmentManager(), pageName, bundle, animations, addToBackStack);
        }
    }
     ...
     */
    @Override
    public Fragment changePage(MyCoreSwitchBean page) {
        boolean addToBackStack = page.isAddToBackStack();
        boolean newActivity = page.isNewActivity();
        Bundle bundle = page.getBundle();
        ...
        if (newActivity) {
            ...
            String pageName = page.getPageName();
            return MyCorePageManager.getInstance().changePageWithNewFragmentManager(getSupportFragmentManager(), pageName, bundle, animations, addToBackStack);
        }
    }
    ...
    public Fragment openPage(String pageName) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, null, CoreAnim.slide);
    ...
    public Fragment openPage(String pageName, Bundle bundle) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, CoreAnim.slide);
        return openPage(page);
    }
    ...
    public Fragment openPage(String pageName, Bundle bundle, CoreAnim coreAnim) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, coreAnim);
        return openPage(page);
    }
     ...
     * @return 打开的fragment对象
     */
    public <T extends MyXPageFragment> T openPage(Class<T> clazz) {
     ...
     * @return 打开的fragment对象
     */
    public <T extends MyXPageFragment> T openPage(Class<T> clazz, Bundle bundle) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(clazz, bundle);
        return (T) openPage(page);
    }
    ...
    public Fragment openPage(String pageName, Bundle bundle, CoreAnim coreAnim, boolean addToBackStack, boolean newActivity) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, coreAnim, addToBackStack, newActivity);
        return openPage(page);
    }
    ...
    public Fragment openPage(String pageName, Bundle bundle, int[] anim, boolean addToBackStack, boolean newActivity) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, anim, addToBackStack, newActivity);
        return openPage(page);
    }
    ...
    public Fragment openPage(String pageName, Bundle bundle, CoreAnim coreAnim, boolean addToBackStack) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, coreAnim, addToBackStack);
        return openPage(page);
    }
    ...
    public Fragment openPage(String pageName, Bundle bundle, int[] anim, boolean addToBackStack) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, anim, addToBackStack);
        return openPage(page);
    }
    ...
    public Fragment openPage(String pageName, Bundle bundle, int[] anim) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, anim);
        return openPage(page);
    }
     ...
     * @return 打开的fragment对象
     */
    public <T extends MyXPageFragment> T changePage(Class<T> clazz) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(PageConfig.getPageInfo(clazz).getName(), null, PageConfig.getPageInfo(clazz).getAnim()).setAddToBackStack(false);
     ...
     * @return 打开的fragment对象
     */
    public <T extends MyXPageFragment> T changePage(Class<T> clazz, Bundle bundle) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(PageConfig.getPageInfo(clazz).getName(), bundle, PageConfig.getPageInfo(clazz).getAnim()).setAddToBackStack(false);
        return (T) changePage(page);
    }
    ...
    public Fragment changePage(String pageName) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, null, CoreAnim.none).setAddToBackStack(false);
    ...
    public Fragment changePage(String pageName, Bundle bundle) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, CoreAnim.none).setAddToBackStack(false);
        return changePage(page);
    }
    ...
    public Fragment changePage(String pageName, Bundle bundle, CoreAnim coreAnim) {
        MyCoreSwitchBean page = new MyCoreSwitchBean(pageName, bundle, coreAnim).setAddToBackStack(false);
        return changePage(page);
    }
     ...
     */
    public MyXPageFragment getActiveFragment() {
        if (this.isFinishing()) {
            return null;
        }
        ...
        if (manager != null) {
            ...
            if (count > 0) {
                ...
                return (MyXPageFragment) manager.findFragmentByTag(tag);
            }
        }
        return null;
    }
     ...
     * @return 获取的页面
     */
    public <T extends MyXPageFragment> T getPage(Class<T> clazz) {
        String pageName = PageConfig.getPageInfo(clazz).getName();
        MyXPageFragment fragment = getPageByName(pageName);
        if (fragment != null) {
            return (T) fragment;
        } else {
            return null;
     ...
     * @return 获取的页面
     */
    public MyXPageFragment getPageByName(String pageName) {
        if (this.isFinishing() || TextUtils.isEmpty(pageName)) {
            return null;
        }
        FragmentManager manager = this.getSupportFragmentManager();
        if (manager != null) {
            return (MyXPageFragment) manager.findFragmentByTag(pageName);
        }
        return null;
    }
    ...
    protected void printAllActivities() {
        ...
        for (WeakReference<MyXPageActivity> ref : sActivities) {
            if (ref != null) {
                MyXPageActivity item = ref.get();
                if (item != null) {
    ...
    private void init(Intent newIntent) {
        try {
            MyCoreSwitchBean page = newIntent.getParcelableExtra(MyCoreSwitchBean.KEY_SWITCH_BEAN);
            boolean startActivityForResult = newIntent.getBooleanExtra(MyCoreSwitchBean.KEY_START_ACTIVITY_FOR_RESULT, false);
            mFirstCoreSwitchBean = page;
            if (page != null) {
                MyXPageFragment fragment = null;
                boolean addToBackStack = page.isAddToBackStack();
                String pageName = page.getPageName();
                Bundle bundle = page.getBundle();
                fragment = MyCorePageManager.getInstance().openPageWithNewFragmentManager(getSupportFragmentManager(), pageName, bundle, null, addToBackStack);
                if (fragment != null) {
                    if (startActivityForResult) {
                        fragment.setRequestCode(page.getRequestCode());
                        fragment.setFragmentFinishListener(new MyXPageFragment.OnFragmentFinishListener() {
                            @Override
                            public void onFragmentResult(int requestCode, int resultCode, Intent intent) {
                                MyXPageActivity.this.setResult(resultCode, intent);
                            }
                        });
                    }
                } else {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        MyXPageFragment activeFragment = getActiveFragment();
