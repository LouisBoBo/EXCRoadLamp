 ...
 */
public interface MyCoreSwitcher {
    /**
     ...
     */
    Fragment gotoPage(MyCoreSwitchBean bean);
     ...
     * @return 打开的页面Fragment对象
     */
    Fragment openPage(MyCoreSwitchBean bean);
     ...
     * @return 打开的页面Fragment对象
     */
    Fragment changePage(MyCoreSwitchBean bean);
     ...
     * @return 打开的页面Fragment对象
     */
    Fragment openPageForResult(final MyCoreSwitchBean page, final MyXPageFragment fragment);
