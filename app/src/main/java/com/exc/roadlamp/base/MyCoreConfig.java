...
public class MyCoreConfig {
    ...
    public static void init(Context context) {
        ...
        MyCorePageManager.getInstance().init(sContext);
    }
    ...
    public static void init(Context context, String pageJson) {
        sContext = context.getApplicationContext();
        MyCorePageManager.getInstance().init(sContext, pageJson);
    }
    ...
    public static void init(Context context, List<PageInfo> pageInfoList) {
        MyCoreConfig.init(context, JSON.toJSONString(pageInfoList));
    }
    ...
    public static void init(Context context, PageInfo pageInfo) {
        ...
        list.add(pageInfo);
        MyCoreConfig.init(context, list);
    }

    public static void readConfig(String pageJson) {
        MyCorePageManager.getInstance().readConfig(pageJson);
    }
